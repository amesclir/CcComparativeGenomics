...
out.file <- "ComparativeGenomicschr34.pdf"
pdf(file=out.file, height=8, width=8, compress=TRUE)
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Link.Plot(links[links[,1]=="chr34",], track.num, TRUE)
dev.off()

out.file <- "ComparativeGenomicschr35.pdf"
pdf(file=out.file, height=8, width=8, compress=TRUE)
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Link.Plot(links[links[,1]=="chr35",], track.num, TRUE)
dev.off()
...
chr34 <- links[links$Chromosome.x=="chr34",]
chr34 <- chr34[order(chr34$chromStart),]
chr34

chr35 <- links[links$Chromosome.x=="chr35",]
chr35 <- chr35[order(chr35$chromStart),]
chr35
...
col_vector[1:36]
col_vector <- c(col_vector[1:36],rep(col_vector[36],1381))
...
links[links[,1]=="chr34", "PlotColor"] <- col_vector[34]
links[links[,1]=="chr35", "PlotColor"] <- col_vector[35]
...
outblock33
outblock34 <- genomeblocks(chr34)
outblock34
outblock35 <- genomeblocks(chr35)
outblock35
...
BCR33
BCR34 <- BCR[BCR$Chromosome=="chr34",]
BCR34
BCR35 <- BCR[BCR$Chromosome=="chr35",]
BCR35
...
```{r}
Genes <- read.csv("Ccristatella_v1.0.DNA_genes.gff", skip = 2, sep = "\t")
Genes
Genes <- Genes[,c(1,4,5)]
Genes
Genes[Genes[,1]=="Ccri_scaffold_1",1] <- "chr1"
Genes[Genes[,1]=="Ccri_scaffold_2",1] <- "chr2"
Genes[Genes[,1]=="Ccri_scaffold_3",1] <- "chr3"
Genes[Genes[,1]=="Ccri_scaffold_4",1] <- "chr4"
Genes[Genes[,1]=="Ccri_scaffold_5",1] <- "chr5"
Genes[Genes[,1]=="Ccri_scaffold_6",1] <- "chr6"
Genes[Genes[,1]=="Ccri_scaffold_7",1] <- "chr7"
Genes[Genes[,1]=="Ccri_scaffold_8",1] <- "chr8"
Genes[Genes[,1]=="Ccri_scaffold_9",1] <- "chr9"
Genes[Genes[,1]=="Ccri_scaffold_10",1] <- "chr10"
Genes[Genes[,1]=="Ccri_scaffold_11",1] <- "chr11"
Genes[Genes[,1]=="Ccri_scaffold_12",1] <- "chr12"
Genes[Genes[,1]=="Ccri_scaffold_13",1] <- "chr13"
Genes[Genes[,1]=="Ccri_scaffold_14",1] <- "chr14"
Genes[Genes[,1]=="Ccri_scaffold_15",1] <- "chr15"
Genes[Genes[,1]=="Ccri_scaffold_16",1] <- "chr16"
Genes[Genes[,1]=="Ccri_scaffold_17",1] <- "chr17"
Genes[Genes[,1]=="Ccri_scaffold_18",1] <- "chr18"
Genes[Genes[,1]=="Ccri_scaffold_19",1] <- "chr19"
Genes[Genes[,1]=="Ccri_scaffold_20",1] <- "chr20"
Genes[Genes[,1]=="Ccri_scaffold_21",1] <- "chr21"
Genes[Genes[,1]=="Ccri_scaffold_22",1] <- "chr22"
Genes[Genes[,1]=="Ccri_scaffold_23",1] <- "chr23"
Genes[Genes[,1]=="Ccri_scaffold_24",1] <- "chr24"
Genes[Genes[,1]=="Ccri_scaffold_25",1] <- "chr25"
Genes[Genes[,1]=="Ccri_scaffold_26",1] <- "chr26"
Genes[Genes[,1]=="Ccri_scaffold_27",1] <- "chr27"
Genes[Genes[,1]=="Ccri_scaffold_28",1] <- "chr28"
Genes[Genes[,1]=="Ccri_scaffold_29",1] <- "chr29"
Genes[Genes[,1]=="Ccri_scaffold_30",1] <- "chr30"
Genes[Genes[,1]=="Ccri_scaffold_31",1] <- "chr31"
Genes[Genes[,1]=="Ccri_scaffold_32",1] <- "chr32"
Genes[Genes[,1]=="Ccri_scaffold_33",1] <- "chr33"
Genes[Genes[,1]=="Ccri_scaffold_34",1] <- "chr34"
Genes[Genes[,1]=="Ccri_scaffold_35",1] <- "chr35"
...
Genes33
Genes34 <- Genes[Genes$Chromosome=="chr34",]
Genes34
Genes35 <- Genes[Genes$Chromosome=="chr35",]
Genes35
...
# Carex scoparia and Carex cristatella got separated ca. 2 mya maximum 
# number of rearrangements are ca. 15 events per million year x 4 my (2 + 2 million years)
# pfis = 0.5
...
c("chr34",0,1,NA),  
bowtie2[bowtie2[,1]=="chr34",][order(bowtie2[bowtie2[,1]=="chr34",2]),], 
c(both[34,1],both[34,3]-1,both[34,3],NA),
c("chr35",0,1,NA),  
bowtie2[bowtie2[,1]=="chr35",][order(bowtie2[bowtie2[,1]=="chr35",2]),], 
c(both[35,1],both[35,3]-1,both[35,3],NA)
)
...
chr34dsimperm <- list()
for (i in 1:perm)
chr34dsimperm[[i]] <- linkssimperm[[i]][linkssimperm[[i]][,1]=="chr34",]
chr35dsimperm <- list()
for (i in 1:perm)
chr35dsimperm[[i]] <- linkssimperm[[i]][linkssimperm[[i]][,1]=="chr35",]
...
```{r}
#TE sent by André Marques refering classII
TE <- read.table("Ccristatella_v1.0.DNA_DNA_transposons.gff", sep = "\t")
TE
TE <- TE[,c(1,4,5)]
TE
TE[TE[,1]=="Ccri_scaffold_1",1] <- "chr1"
TE[TE[,1]=="Ccri_scaffold_2",1] <- "chr2"
TE[TE[,1]=="Ccri_scaffold_3",1] <- "chr3"
TE[TE[,1]=="Ccri_scaffold_4",1] <- "chr4"
TE[TE[,1]=="Ccri_scaffold_5",1] <- "chr5"
TE[TE[,1]=="Ccri_scaffold_6",1] <- "chr6"
TE[TE[,1]=="Ccri_scaffold_7",1] <- "chr7"
TE[TE[,1]=="Ccri_scaffold_8",1] <- "chr8"
TE[TE[,1]=="Ccri_scaffold_9",1] <- "chr9"
TE[TE[,1]=="Ccri_scaffold_10",1] <- "chr10"
TE[TE[,1]=="Ccri_scaffold_11",1] <- "chr11"
TE[TE[,1]=="Ccri_scaffold_12",1] <- "chr12"
TE[TE[,1]=="Ccri_scaffold_13",1] <- "chr13"
TE[TE[,1]=="Ccri_scaffold_14",1] <- "chr14"
TE[TE[,1]=="Ccri_scaffold_15",1] <- "chr15"
TE[TE[,1]=="Ccri_scaffold_16",1] <- "chr16"
TE[TE[,1]=="Ccri_scaffold_17",1] <- "chr17"
TE[TE[,1]=="Ccri_scaffold_18",1] <- "chr18"
TE[TE[,1]=="Ccri_scaffold_19",1] <- "chr19"
TE[TE[,1]=="Ccri_scaffold_20",1] <- "chr20"
TE[TE[,1]=="Ccri_scaffold_21",1] <- "chr21"
TE[TE[,1]=="Ccri_scaffold_22",1] <- "chr22"
TE[TE[,1]=="Ccri_scaffold_23",1] <- "chr23"
TE[TE[,1]=="Ccri_scaffold_24",1] <- "chr24"
TE[TE[,1]=="Ccri_scaffold_25",1] <- "chr25"
TE[TE[,1]=="Ccri_scaffold_26",1] <- "chr26"
TE[TE[,1]=="Ccri_scaffold_27",1] <- "chr27"
TE[TE[,1]=="Ccri_scaffold_28",1] <- "chr28"
TE[TE[,1]=="Ccri_scaffold_29",1] <- "chr29"
TE[TE[,1]=="Ccri_scaffold_30",1] <- "chr30"
TE[TE[,1]=="Ccri_scaffold_31",1] <- "chr31"
TE[TE[,1]=="Ccri_scaffold_32",1] <- "chr32"
TE[TE[,1]=="Ccri_scaffold_33",1] <- "chr33"
TE[TE[,1]=="Ccri_scaffold_34",1] <- "chr34"
TE[TE[,1]=="Ccri_scaffold_35",1] <- "chr35"
...
TE_33
TE_34 <- TE[TE$Chromosome=="chr34",]
TE_34
TE_35 <- TE[TE$Chromosome=="chr35",]
TE_35
...
```{r}
satDNA <- read.table("Ccristatella_v1.0.DNA_CenDNA.gff", sep = "\t")
satDNA
satDNA <- satDNA[,c(1,4,5)]
satDNA
satDNA[satDNA[,1]=="Ccri_scaffold_1",1] <- "chr1"
satDNA[satDNA[,1]=="Ccri_scaffold_2",1] <- "chr2"
satDNA[satDNA[,1]=="Ccri_scaffold_3",1] <- "chr3"
satDNA[satDNA[,1]=="Ccri_scaffold_4",1] <- "chr4"
satDNA[satDNA[,1]=="Ccri_scaffold_5",1] <- "chr5"
satDNA[satDNA[,1]=="Ccri_scaffold_6",1] <- "chr6"
satDNA[satDNA[,1]=="Ccri_scaffold_7",1] <- "chr7"
satDNA[satDNA[,1]=="Ccri_scaffold_8",1] <- "chr8"
satDNA[satDNA[,1]=="Ccri_scaffold_9",1] <- "chr9"
satDNA[satDNA[,1]=="Ccri_scaffold_10",1] <- "chr10"
satDNA[satDNA[,1]=="Ccri_scaffold_11",1] <- "chr11"
satDNA[satDNA[,1]=="Ccri_scaffold_12",1] <- "chr12"
satDNA[satDNA[,1]=="Ccri_scaffold_13",1] <- "chr13"
satDNA[satDNA[,1]=="Ccri_scaffold_14",1] <- "chr14"
satDNA[satDNA[,1]=="Ccri_scaffold_15",1] <- "chr15"
satDNA[satDNA[,1]=="Ccri_scaffold_16",1] <- "chr16"
satDNA[satDNA[,1]=="Ccri_scaffold_17",1] <- "chr17"
satDNA[satDNA[,1]=="Ccri_scaffold_18",1] <- "chr18"
satDNA[satDNA[,1]=="Ccri_scaffold_19",1] <- "chr19"
satDNA[satDNA[,1]=="Ccri_scaffold_20",1] <- "chr20"
satDNA[satDNA[,1]=="Ccri_scaffold_21",1] <- "chr21"
satDNA[satDNA[,1]=="Ccri_scaffold_22",1] <- "chr22"
satDNA[satDNA[,1]=="Ccri_scaffold_23",1] <- "chr23"
satDNA[satDNA[,1]=="Ccri_scaffold_24",1] <- "chr24"
satDNA[satDNA[,1]=="Ccri_scaffold_25",1] <- "chr25"
satDNA[satDNA[,1]=="Ccri_scaffold_26",1] <- "chr26"
satDNA[satDNA[,1]=="Ccri_scaffold_27",1] <- "chr27"
satDNA[satDNA[,1]=="Ccri_scaffold_28",1] <- "chr28"
satDNA[satDNA[,1]=="Ccri_scaffold_29",1] <- "chr29"
satDNA[satDNA[,1]=="Ccri_scaffold_30",1] <- "chr30"
satDNA[satDNA[,1]=="Ccri_scaffold_31",1] <- "chr31"
satDNA[satDNA[,1]=="Ccri_scaffold_32",1] <- "chr32"
satDNA[satDNA[,1]=="Ccri_scaffold_33",1] <- "chr33"
satDNA[satDNA[,1]=="Ccri_scaffold_34",1] <- "chr34"
satDNA[satDNA[,1]=="Ccri_scaffold_35",1] <- "chr35"
...
satDNA_33
satDNA_34 <- satDNA[satDNA$Chromosome=="chr34",]
satDNA_34
satDNA_35 <- satDNA[satDNA$Chromosome=="chr35",]
satDNA_35
...
gypsy <- read.table("Ccristatella_v1.0.DNA_Ty3-Gypsy.gff", sep = "\t")
gypsy
gypsy <- gypsy[,c(1,4,5)]
gypsy
gypsy[gypsy[,1]=="Ccri_scaffold_1",1] <- "chr1"
gypsy[gypsy[,1]=="Ccri_scaffold_2",1] <- "chr2"
gypsy[gypsy[,1]=="Ccri_scaffold_3",1] <- "chr3"
gypsy[gypsy[,1]=="Ccri_scaffold_4",1] <- "chr4"
gypsy[gypsy[,1]=="Ccri_scaffold_5",1] <- "chr5"
gypsy[gypsy[,1]=="Ccri_scaffold_6",1] <- "chr6"
gypsy[gypsy[,1]=="Ccri_scaffold_7",1] <- "chr7"
gypsy[gypsy[,1]=="Ccri_scaffold_8",1] <- "chr8"
gypsy[gypsy[,1]=="Ccri_scaffold_9",1] <- "chr9"
gypsy[gypsy[,1]=="Ccri_scaffold_10",1] <- "chr10"
gypsy[gypsy[,1]=="Ccri_scaffold_11",1] <- "chr11"
gypsy[gypsy[,1]=="Ccri_scaffold_12",1] <- "chr12"
gypsy[gypsy[,1]=="Ccri_scaffold_13",1] <- "chr13"
gypsy[gypsy[,1]=="Ccri_scaffold_14",1] <- "chr14"
gypsy[gypsy[,1]=="Ccri_scaffold_15",1] <- "chr15"
gypsy[gypsy[,1]=="Ccri_scaffold_16",1] <- "chr16"
gypsy[gypsy[,1]=="Ccri_scaffold_17",1] <- "chr17"
gypsy[gypsy[,1]=="Ccri_scaffold_18",1] <- "chr18"
gypsy[gypsy[,1]=="Ccri_scaffold_19",1] <- "chr19"
gypsy[gypsy[,1]=="Ccri_scaffold_20",1] <- "chr20"
gypsy[gypsy[,1]=="Ccri_scaffold_21",1] <- "chr21"
gypsy[gypsy[,1]=="Ccri_scaffold_22",1] <- "chr22"
gypsy[gypsy[,1]=="Ccri_scaffold_23",1] <- "chr23"
gypsy[gypsy[,1]=="Ccri_scaffold_24",1] <- "chr24"
gypsy[gypsy[,1]=="Ccri_scaffold_25",1] <- "chr25"
gypsy[gypsy[,1]=="Ccri_scaffold_26",1] <- "chr26"
gypsy[gypsy[,1]=="Ccri_scaffold_27",1] <- "chr27"
gypsy[gypsy[,1]=="Ccri_scaffold_28",1] <- "chr28"
gypsy[gypsy[,1]=="Ccri_scaffold_29",1] <- "chr29"
gypsy[gypsy[,1]=="Ccri_scaffold_30",1] <- "chr30"
gypsy[gypsy[,1]=="Ccri_scaffold_31",1] <- "chr31"
gypsy[gypsy[,1]=="Ccri_scaffold_32",1] <- "chr32"
gypsy[gypsy[,1]=="Ccri_scaffold_33",1] <- "chr33"
gypsy[gypsy[,1]=="Ccri_scaffold_34",1] <- "chr34"
gypsy[gypsy[,1]=="Ccri_scaffold_35",1] <- "chr35"
...
gypsy_33
gypsy_34 <- gypsy[gypsy$Chromosome=="chr34",]
gypsy_34
gypsy_35 <- gypsy[gypsy$Chromosome=="chr35",]
gypsy_35
...
copia <- read.table("Ccristatella_v1.0.DNA_Ty1-Copia.gff", sep = "\t")
copia
copia <- copia[,c(1,4,5)]
copia
copia[copia[,1]=="Ccri_scaffold_1",1] <- "chr1"
copia[copia[,1]=="Ccri_scaffold_2",1] <- "chr2"
copia[copia[,1]=="Ccri_scaffold_3",1] <- "chr3"
copia[copia[,1]=="Ccri_scaffold_4",1] <- "chr4"
copia[copia[,1]=="Ccri_scaffold_5",1] <- "chr5"
copia[copia[,1]=="Ccri_scaffold_6",1] <- "chr6"
copia[copia[,1]=="Ccri_scaffold_7",1] <- "chr7"
copia[copia[,1]=="Ccri_scaffold_8",1] <- "chr8"
copia[copia[,1]=="Ccri_scaffold_9",1] <- "chr9"
copia[copia[,1]=="Ccri_scaffold_10",1] <- "chr10"
copia[copia[,1]=="Ccri_scaffold_11",1] <- "chr11"
copia[copia[,1]=="Ccri_scaffold_12",1] <- "chr12"
copia[copia[,1]=="Ccri_scaffold_13",1] <- "chr13"
copia[copia[,1]=="Ccri_scaffold_14",1] <- "chr14"
copia[copia[,1]=="Ccri_scaffold_15",1] <- "chr15"
copia[copia[,1]=="Ccri_scaffold_16",1] <- "chr16"
copia[copia[,1]=="Ccri_scaffold_17",1] <- "chr17"
copia[copia[,1]=="Ccri_scaffold_18",1] <- "chr18"
copia[copia[,1]=="Ccri_scaffold_19",1] <- "chr19"
copia[copia[,1]=="Ccri_scaffold_20",1] <- "chr20"
copia[copia[,1]=="Ccri_scaffold_21",1] <- "chr21"
copia[copia[,1]=="Ccri_scaffold_22",1] <- "chr22"
copia[copia[,1]=="Ccri_scaffold_23",1] <- "chr23"
copia[copia[,1]=="Ccri_scaffold_24",1] <- "chr24"
copia[copia[,1]=="Ccri_scaffold_25",1] <- "chr25"
copia[copia[,1]=="Ccri_scaffold_26",1] <- "chr26"
copia[copia[,1]=="Ccri_scaffold_27",1] <- "chr27"
copia[copia[,1]=="Ccri_scaffold_28",1] <- "chr28"
copia[copia[,1]=="Ccri_scaffold_29",1] <- "chr29"
copia[copia[,1]=="Ccri_scaffold_30",1] <- "chr30"
copia[copia[,1]=="Ccri_scaffold_31",1] <- "chr31"
copia[copia[,1]=="Ccri_scaffold_32",1] <- "chr32"
copia[copia[,1]=="Ccri_scaffold_33",1] <- "chr33"
copia[copia[,1]=="Ccri_scaffold_34",1] <- "chr34"
copia[copia[,1]=="Ccri_scaffold_35",1] <- "chr35"
...
copia_33
copia_34 <- copia[copia$Chromosome=="chr34",]
copia_34
copia_35 <- copia[copia$Chromosome=="chr35",]
copia_35
...
genomeblockscopia_34d <- genomeblocksBCR(outblock34, copia_34)
genomeblockscopia_34d
genomeblockscopia_35d <- genomeblocksBCR(outblock35, copia_35)
genomeblockscopia_35d

genomeblockscopia_alld <- rbind(genomeblockscopia_1d,genomeblockscopia_2d,genomeblockscopia_3d,genomeblockscopia_4d,genomeblockscopia_5d,genomeblockscopia_6d,genomeblockscopia_7d,genomeblockscopia_8d,genomeblockscopia_9d,genomeblockscopia_10d,genomeblockscopia_11d,genomeblockscopia_12d,genomeblockscopia_13d,genomeblockscopia_14d,genomeblockscopia_15d,genomeblockscopia_16d,genomeblockscopia_17d,genomeblockscopia_18d,genomeblockscopia_19d,genomeblockscopia_20d,genomeblockscopia_21d,genomeblockscopia_22d,genomeblockscopia_23d,genomeblockscopia_24d,genomeblockscopia_25d,genomeblockscopia_26d,genomeblockscopia_27d,genomeblockscopia_28d,genomeblockscopia_29d,genomeblockscopia_30d,genomeblockscopia_31d,genomeblockscopia_32d,genomeblockscopia_33d,genomeblockscopia_34d,genomeblockscopia_35d)
...
non_LTR <- read.table("Ccristatella_v1.0.DNA_LINE.gff", sep = "\t")
non_LTR
non_LTR <- non_LTR[,c(1,4,5)]
non_LTR
non_LTR[non_LTR[,1]=="Ccri_scaffold_1",1] <- "chr1"
non_LTR[non_LTR[,1]=="Ccri_scaffold_2",1] <- "chr2"
non_LTR[non_LTR[,1]=="Ccri_scaffold_3",1] <- "chr3"
non_LTR[non_LTR[,1]=="Ccri_scaffold_4",1] <- "chr4"
non_LTR[non_LTR[,1]=="Ccri_scaffold_5",1] <- "chr5"
non_LTR[non_LTR[,1]=="Ccri_scaffold_6",1] <- "chr6"
non_LTR[non_LTR[,1]=="Ccri_scaffold_7",1] <- "chr7"
non_LTR[non_LTR[,1]=="Ccri_scaffold_8",1] <- "chr8"
non_LTR[non_LTR[,1]=="Ccri_scaffold_9",1] <- "chr9"
non_LTR[non_LTR[,1]=="Ccri_scaffold_10",1] <- "chr10"
non_LTR[non_LTR[,1]=="Ccri_scaffold_11",1] <- "chr11"
non_LTR[non_LTR[,1]=="Ccri_scaffold_12",1] <- "chr12"
non_LTR[non_LTR[,1]=="Ccri_scaffold_13",1] <- "chr13"
non_LTR[non_LTR[,1]=="Ccri_scaffold_14",1] <- "chr14"
non_LTR[non_LTR[,1]=="Ccri_scaffold_15",1] <- "chr15"
non_LTR[non_LTR[,1]=="Ccri_scaffold_16",1] <- "chr16"
non_LTR[non_LTR[,1]=="Ccri_scaffold_17",1] <- "chr17"
non_LTR[non_LTR[,1]=="Ccri_scaffold_18",1] <- "chr18"
non_LTR[non_LTR[,1]=="Ccri_scaffold_19",1] <- "chr19"
non_LTR[non_LTR[,1]=="Ccri_scaffold_20",1] <- "chr20"
non_LTR[non_LTR[,1]=="Ccri_scaffold_21",1] <- "chr21"
non_LTR[non_LTR[,1]=="Ccri_scaffold_22",1] <- "chr22"
non_LTR[non_LTR[,1]=="Ccri_scaffold_23",1] <- "chr23"
non_LTR[non_LTR[,1]=="Ccri_scaffold_24",1] <- "chr24"
non_LTR[non_LTR[,1]=="Ccri_scaffold_25",1] <- "chr25"
non_LTR[non_LTR[,1]=="Ccri_scaffold_26",1] <- "chr26"
non_LTR[non_LTR[,1]=="Ccri_scaffold_27",1] <- "chr27"
non_LTR[non_LTR[,1]=="Ccri_scaffold_28",1] <- "chr28"
non_LTR[non_LTR[,1]=="Ccri_scaffold_29",1] <- "chr29"
non_LTR[non_LTR[,1]=="Ccri_scaffold_30",1] <- "chr30"
non_LTR[non_LTR[,1]=="Ccri_scaffold_31",1] <- "chr31"
non_LTR[non_LTR[,1]=="Ccri_scaffold_32",1] <- "chr32"
non_LTR[non_LTR[,1]=="Ccri_scaffold_33",1] <- "chr33"
non_LTR[non_LTR[,1]=="Ccri_scaffold_34",1] <- "chr34"
non_LTR[non_LTR[,1]=="Ccri_scaffold_35",1] <- "chr35"
...
non_LTR_33
non_LTR_34 <- non_LTR[non_LTR$Chromosome=="chr34",]
non_LTR_34
non_LTR_35 <- non_LTR[non_LTR$Chromosome=="chr35",]
non_LTR_35
...
genomeblocksnon_LTR_34d <- genomeblocksBCR(outblock34, non_LTR_34)
genomeblocksnon_LTR_34d
genomeblocksnon_LTR_35d <- genomeblocksBCR(outblock35, non_LTR_35)
genomeblocksnon_LTR_35d

genomeblocksnon_LTR_alld <- rbind(genomeblocksnon_LTR_1d,genomeblocksnon_LTR_2d,genomeblocksnon_LTR_3d,genomeblocksnon_LTR_4d,genomeblocksnon_LTR_5d,genomeblocksnon_LTR_6d,genomeblocksnon_LTR_7d,genomeblocksnon_LTR_8d,genomeblocksnon_LTR_9d,genomeblocksnon_LTR_10d,genomeblocksnon_LTR_11d,genomeblocksnon_LTR_12d,genomeblocksnon_LTR_13d,genomeblocksnon_LTR_14d,genomeblocksnon_LTR_15d,genomeblocksnon_LTR_16d,genomeblocksnon_LTR_17d,genomeblocksnon_LTR_18d,genomeblocksnon_LTR_19d,genomeblocksnon_LTR_20d,genomeblocksnon_LTR_21d,genomeblocksnon_LTR_22d,genomeblocksnon_LTR_23d,genomeblocksnon_LTR_24d,genomeblocksnon_LTR_25d,genomeblocksnon_LTR_26d,genomeblocksnon_LTR_27d,genomeblocksnon_LTR_28d,genomeblocksnon_LTR_29d,genomeblocksnon_LTR_30d,genomeblocksnon_LTR_31d,genomeblocksnon_LTR_32d,genomeblocksnon_LTR_33d,genomeblocksnon_LTR_34d,genomeblocksnon_LTR_35d)
...
fittedModel <- glmer (as.numeric(type) ~ as.numeric(BCR) + as.numeric(Genes) + as.numeric(satDNA)+ as.numeric(copia) + as.numeric(gypsy) + as.numeric(non_LTR) + (1|chromosome), data = glm_genomeblocks_alld, family = binomial(link = "logit"))
summary(fittedModel)
